...
FLOW_ID = "38119a37-38a5-4566-810c-4ac486f0c7be"
...
TWEAKS = {
  ...
  "ChatInput-wWLuP": {
    "files": "",
    "input_value": "1. כמה עולה galaxy s23?\n\n2. באיזה צבעים יש galaxy s23 ultra?\n\n3. כמה עולה galaxy s24?\n\n4. מה ההבדל בין galaxy plus לבין הgalaxy ultra?",
    "sender": "User",
    "sender_name": "User",
    "session_id": "",
    "should_store_message": True
